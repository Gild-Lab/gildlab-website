      ...
      <div class="chart-table">
        <div class="eye-icon">
          <svg width="108" height="78" viewBox="0 0 108 78" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M74.25 39C74.25 49.7696 65.1838 58.5 54 58.5C42.8162 58.5 33.75 49.7696 33.75 39C33.75 28.2304 42.8162 19.5 54 19.5C56.0754 19.5 58.0779 19.8007 59.963 20.3592C56.447 21.8878 54 25.2937 54 29.25C54 34.6348 58.5331 39 64.125 39C68.2334 39 71.7703 36.6437 73.3578 33.2578C73.9378 35.0732 74.25 37.0015 74.25 39Z"
                fill="black"/>
        ...
        <table class="fw-700">
          ...
          <tr>
            <th></th>
            <th></th>
            <th colspan="2">Regular View</th>
            <th>SFT View</th>
          </tr>
          </thead>
          <tbody>
          <tr>
            <td class="br-3">Words</td>
            <td class="br-3 bt-3 bb-3 bg-green">Trustworthy</td>
            <td class="bt-3 br-3 bb-3 bg-green">DAO <br/> + <br/> Marketplace</td>
          </tr>
          <tr>
